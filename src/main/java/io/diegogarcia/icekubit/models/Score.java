...
public class Score {
    ...
    private void addWinningSetsOfFirstPlayer() {
        winningSetsOfFirstPlayer++;
        if (winningSetsOfFirstPlayer == 2)
            isFinished = true;
    }

    private void addWinningSetsOfSecondPlayer() {
        winningSetsOfSecondPlayer++;
        if (winningSetsOfSecondPlayer == 2)
            isFinished = true;
    }
}
